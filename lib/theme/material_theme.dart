...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff166683),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff2c7593),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff494567),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff494567),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff5599b9),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xffcadfec),
      onSecondary: Color(0xff142832),
      secondaryContainer: Color(0xff7f94a0),
      onSecondaryContainer: Color(0xff000000),
      tertiary: Color(0xffded8ff),
      onTertiary: Color(0xff252241),
      tertiaryContainer: Color(0xff918cb2),
      ...
      surfaceContainer: Color(0xff24292c),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff89cbed),
      onPrimaryContainer: Color(0xff000d14),
      secondary: Color(0xffe0f3ff),
      onSecondary: Color(0xff000000),
      secondaryContainer: Color(0xffb1c6d2),
      onSecondaryContainer: Color(0xff000d14),
      tertiary: Color(0xfff2edff),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xffc4bee6),
      onTertiaryContainer: Color(0xff0a0625),
